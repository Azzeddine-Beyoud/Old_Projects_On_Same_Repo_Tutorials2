package com.example.cardview_swipe.Halper;
...
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
        ...
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            if (dX < 0) {
                ...
                if (!buttonBuffer.containsKey(pos)) {
                    ...
                    instanatiateMybutton(viewHolder, buffer);
                ...
                drowButton(c, itemView, buffer, pos, translationX);
    ...
    private void drowButton(Canvas c, View itemView, List<MyButton> buffer, int pos, float translationX) {
    ...
    public abstract void instanatiateMybutton(RecyclerView.ViewHolder viewHolder, List<MyButton> buffer);
}
