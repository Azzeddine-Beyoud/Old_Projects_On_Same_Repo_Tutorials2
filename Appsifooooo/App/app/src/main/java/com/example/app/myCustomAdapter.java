...
//////////////////////////////////////////////////////////////////////
       ...
       final Intent callme=new Intent(Intent.ACTION_DIAL);
        callme.setData(Uri.parse("tel:"+txtphonenumber.getText()));
...
star.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View v) {
        favoritems.add(new list(painteritems.get(position).name.toString(),painteritems.get(position).Lastname.toString(),painteritems.get(position).Phonenumber.toString(),painteritems.get(position).city.toString()));
